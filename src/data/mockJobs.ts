...
export const mockReworkSuggestions = {
  ...
  rationale: 'Based on historical data with this material and thickness, the machine tends to overbend by 3-4 degrees on 90° angles. Compensation of -3.5° recommended.'
};